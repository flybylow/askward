...
- [v2-overview.md](./v2-overview.md) — v2 scope and reading order
...
- [elevenlabs-knowledge-base.md](./elevenlabs-knowledge-base.md) — authoritative 5-chapter KB for ElevenLabs (paste into Knowledge Base)
- [elevenlabs-topics-knowledge-base.md](./elevenlabs-topics-knowledge-base.md) — legacy 14-topic KB (deprecated)
- [developer-handoff-v1.md](./developer-handoff-v1.md) — v1 spec (architecture, file map, Ward TODOs)
- [elevenlabs-system-prompt.md](./elevenlabs-system-prompt.md) — v1 system prompt (deprecated)
